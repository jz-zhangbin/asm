    ...
    methods: {
        AjaxPie() {
            ...
            let obj = {
                ...
                begingTime: datefn(2)[this.$parent.$parent.propDate].data
                    .beginTime,
                        ...
                        label: {
                            normal: {
                                ...
                                formatter: function(v) {
                                    ...
                                    let newstr = name.substring(
                                        0,
                                        Math.min.apply(null, tmp)
                                    );
                                    if (newstr.length <= 20) {
                                        return newstr + "-" + num;
                                    } else {
                                        var lastStr2 = newstr.substring(
                                            0,
                                            newstr.lastIndexOf("")
                                        );
                                        return lastStr2 + "-" + num;

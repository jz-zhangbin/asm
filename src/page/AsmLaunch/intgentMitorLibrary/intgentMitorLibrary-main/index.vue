         ...
         <div class="table">
               ...
               show-overflow-tooltip>
                <template slot-scope="scope">
                     <router-link :to="{path: '/intgentMitorLibrary/MonitoringRules?id='+scope.row.id+''}"> 
                ...
                align='center'>
                 <template slot-scope="scope">
                     <div style="text-align:left">
                         账户： <span style="color:red">asdasdasd</span> 
                     </div>
                     <div style="text-align:left">
                        广告系列：<span  style="color:red">{{scope.row.SearchIndex}}</span>
                     </div>
                </template>
                </el-table-column>
                <el-table-column

...
<template>
    <div class="group_index">
        <div class="account_table">
            ...
            <el-table ref="multipleTable" :data="tableGroup" style="width: 100%" highlight-current-row border @selection-change="handleSelectionChange" @sort-change='sortchange' v-loading="loadingGroup" :default-sort="sortInfor">
                <el-table-column fixed align='center' label="广告组名称" min-width="240" prop="adgroupName">
                ...
                <el-table-column align='center' label="当日回收" min-width="110">
                    <template slot-scope="scope">
                        -
                    </template>
                </el-table-column>
            ...
            <div class="content_page">
                <el-pagination :current-page="pageIndex" background :page-size="20" @current-change="handleCurrentChange" layout="prev, pager, next" :total="tableGrouptotal">
                </el-pagination>
            </div>
        </div>
    </div>
    ...
    methods: {
        sortchange(a) {
            ...
            if (a.order != null) {
                ...
                this.total = 0;
                //进行请求
                if (this.$parent.appadimad != "") {
                    this.$parent.AjaxGroup(
                        this.$parent.appadimad,
                        this.pageIndex,
                        a.prop,
        ...
        caoClick(index) {
            ...
            switch (type) {
                case "导出":
                    ...
                    this.$parent.AjaxGroupExcel("广告组");
                    break;
            }
        },
        togroup(data) {

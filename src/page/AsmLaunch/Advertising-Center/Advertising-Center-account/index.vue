  ...
  <div class="account_index">
     ...
     <div class="account_contant">
       ...
       <div class="account_ul">
         <ul>
           <li v-for="(ele,index) in accountData" :key="index">
             <span>{{ele.value}}</span>
             <p>{{ele.name}}</p>
           </li>
         </ul>
       ...
       <div class="account_table">
         <el-table
            ...
            <template slot-scope="scope"> 
              <div class="acconut_table_a" :title="scope.row.name" @click="advaerTolist(scope.row.name,scope.row.num3)">
                {{scope.row.name}}
              </div>
            </template>
            </el-table-column>

                    ...
                    <div class="account_search_cao" @click="caoShow = !caoShow">
                        ...
                        <transition name="el-zoom-in-top">
                            <section style="width:130px;" v-show="caoShow" @mouseout="caoShow = false" @mousemove="caoShow = true">
                                <span :class="{stop: $route.params.listType == 'remove' && index != 0}" v-for="(ele,index) in caoList" :key="index" @click="caoClick(index)">{{ele}}</span>
                            </section>
                        </transition>
                    </div>
...
//import Negative from "./Add-searchTerms-Negative";
